...
export default {
  ...
  setup() {
    ...
    const precomputedAttrs = computed(() => {
      ...
      return {
        outerWrapper: mergeWrapper('textarea', 'outer-wrapper', pageType, COMPONENT_CONFIG),
        secondWrapper: mergeWrapper('textarea', 'second-p', pageType, COMPONENT_CONFIG),
        field: mergeField('textarea', pageType, COMPONENT_CONFIG)
      }
    })
